    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <_Builtin.Image
              className={_utils.cx(_styles, "logo-icon")}
              editable={false}
              width="64"
              height="64"
              loading="eager"
          ...
          <_Builtin.VFlex
            className={_utils.cx(_styles, "navbar-menu-wrapper")}
            tag="div"
          >
            <_Builtin.Block
              className={_utils.cx(
            ...
            >
              <_Builtin.Block
                className={_utils.cx(_styles, "navbar-dropdown-item-wrapper")}
                tag="div"
              >
                <_Builtin.Block
                  className={_utils.cx(_styles, "navbar-item-wrapper")}
                  editable={true}
                  tag="section"
                >
                ...
                <_Builtin.Block
                  className={_utils.cx(_styles, "navbar-dropdown-list-wrapper")}
                  tag="div"
                >
                  <_Builtin.Block
                    className={_utils.cx(_styles, "navbar-popover-arrow")}
                    tag="div"
                  />
                  <_Builtin.Block
          ...
          <_Builtin.Block
            className={_utils.cx(_styles, "navbar-menu-overlay")}
            data-w-id="62b33408-518a-bd6c-a47e-55fa8a1a886b"
            tag="div"
          />
          <_Builtin.Link
            className={_utils.cx(_styles, "menu-button", "hide")}
          ...
          <_Builtin.Link
            className={_utils.cx(_styles, "menu-button", "show")}
