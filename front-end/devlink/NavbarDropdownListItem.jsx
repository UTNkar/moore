...
import _styles from "./NavbarDropdownListItem.module.css";
...
export function NavbarDropdownListItem({
  ...
  return (
    <_Component tag="main">
      <_Builtin.Link
        className={_utils.cx(_styles, "navbar-dropdown-list-item-wrapper")}
      ...
      >
        <_Builtin.VFlex
          className={_utils.cx(
            _styles,
            "navbar-dropdown-list-item-label-wrapper"
          )}
          tag="div"
        >
          <_Builtin.Heading
        ...
        {showDescription ? (
          <_Builtin.Paragraph
            className={_utils.cx(_styles, "navbar-dropdown-list-description")}
          >
            {description}
          </_Builtin.Paragraph>
        ) : null}
